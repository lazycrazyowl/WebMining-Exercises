 ...
 * @generated */
public class StemTF_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (StemTF_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = StemTF_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new StemTF(addr, StemTF_Type.this);
  			   StemTF_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new StemTF(addr, StemTF_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = StemTF.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.tudarmstadt.ke.webmining2011.types.StemTF");
  ...
  public boolean getStopword(int addr) {
      ...
      jcas.throwFeatMissing("stopword", "de.tudarmstadt.ke.webmining2011.types.StemTF");
  ...
  public float getTfidf(int addr) {
      ...
      jcas.throwFeatMissing("tfidf", "de.tudarmstadt.ke.webmining2011.types.StemTF");
  ...
  public float getPropability(int addr) {
      ...
      jcas.throwFeatMissing("propability", "de.tudarmstadt.ke.webmining2011.types.StemTF");
  ...
  public int getCount(int addr) {
      ...
      jcas.throwFeatMissing("count", "de.tudarmstadt.ke.webmining2011.types.StemTF");
  ...
  public String getToken(int addr) {
      ...
      jcas.throwFeatMissing("token", "de.tudarmstadt.ke.webmining2011.types.StemTF");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public StemTF_Type(JCas jcas, Type casType) {
    super(jcas, casType);
