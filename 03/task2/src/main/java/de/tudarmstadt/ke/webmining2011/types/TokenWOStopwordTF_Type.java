 ...
 * @generated */
public class TokenWOStopwordTF_Type extends Annotation_Type {
  /** @generated */
  ...
  private final FSGenerator fsGenerator = 
    new FSGenerator() {
      public FeatureStructure createFS(int addr, CASImpl cas) {
  			 if (TokenWOStopwordTF_Type.this.useExistingInstance) {
  			   // Return eq fs instance if already created
  		     FeatureStructure fs = TokenWOStopwordTF_Type.this.jcas.getJfsFromCaddr(addr);
  		     if (null == fs) {
  		       fs = new TokenWOStopwordTF(addr, TokenWOStopwordTF_Type.this);
  			   TokenWOStopwordTF_Type.this.jcas.putJfsFromCaddr(addr, fs);
  			   return fs;
  		     }
  		     return fs;
        } else return new TokenWOStopwordTF(addr, TokenWOStopwordTF_Type.this);
  	  }
    };
  /** @generated */
  public final static int typeIndexID = TokenWOStopwordTF.typeIndexID;
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.tudarmstadt.ke.webmining2011.types.TokenWOStopwordTF");
  ...
  public boolean getStopword(int addr) {
      ...
      jcas.throwFeatMissing("stopword", "de.tudarmstadt.ke.webmining2011.types.TokenWOStopwordTF");
  ...
  public float getTfidf(int addr) {
      ...
      jcas.throwFeatMissing("tfidf", "de.tudarmstadt.ke.webmining2011.types.TokenWOStopwordTF");
  ...
  public float getPropability(int addr) {
      ...
      jcas.throwFeatMissing("propability", "de.tudarmstadt.ke.webmining2011.types.TokenWOStopwordTF");
  ...
  public int getCount(int addr) {
      ...
      jcas.throwFeatMissing("count", "de.tudarmstadt.ke.webmining2011.types.TokenWOStopwordTF");
  ...
  public String getToken(int addr) {
      ...
      jcas.throwFeatMissing("token", "de.tudarmstadt.ke.webmining2011.types.TokenWOStopwordTF");
  ...
  /** initialize variables to correspond with Cas Type and Features
	* @generated */
  public TokenWOStopwordTF_Type(JCas jcas, Type casType) {
    super(jcas, casType);
